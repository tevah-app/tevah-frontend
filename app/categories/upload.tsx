...
//       const res = await fetch("http://192.168.43.240:4000/api/media/upload", {
//         method: "POST",
//         headers: {
...
//       <Text className="text-center text-lg font-semibold mt-4">New Upload</Text>
...
//             />
//           ) : (
//             <Text className="px-4 text-gray-700 text-center">{file.name}</Text>
//           )}
//         </TouchableOpacity>
//       </View>
...
//       router.push(`/categories/HomeTabContent?default=${destination}`);
//     } catch (error) {
//       setLoading(false);
//       console.error("❌ Upload error:", error);
//       Alert.alert("Error", "Something went wrong during upload.");
